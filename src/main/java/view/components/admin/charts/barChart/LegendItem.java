...
public class LegendItem extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbColor = new view.components.admin.charts.barChart.LabelColor();

        lbName.setFont(new java.awt.Font("Iceland", 1, 18)); // NOI18N
    ...
    private view.components.admin.charts.barChart.LabelColor lbColor;
