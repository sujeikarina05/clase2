package view.components.customComboBox;
...
public class Combobox<E> extends JComboBox<E> {
    ...
    private Color caretColor = new Color(50, 50, 50);
    private String labeText = "Label";
    private Color lineColor = new Color(66, 100, 250);
    ...
    private class ComboUI extends BasicComboBoxUI {
        ...
        public void paint(Graphics grphcs, JComponent jc) {
            ...
            if (mouseOver) {
                ...
                g2.setColor(combo.getCaretColor());
            }
