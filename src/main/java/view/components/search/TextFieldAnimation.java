package view.components.search;
...
public class TextFieldAnimation extends JTextField {
    ...
    private Color backgroundColor = new Color(45,52,63);
    private Color animationColor = new Color(36, 39, 42);
    private final Icon iconSearch;
    private final Icon iconLoading;
    private String hintText = "Busca un producto";
    ...
    public TextFieldAnimation() {
        ...
        setFont(new java.awt.Font("iceland", 0, 18));
        setSelectionColor(new Color(30, 37, 38));
        iconSearch = new ImageIcon(getClass().getResource("/icons/search.png"));
        iconLoading = new ImageIcon(getClass().getResource("/icons/loading.gif"));
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, new Color(0,0,0), width, 0, animationColor);
        g2.setPaint(gra);
